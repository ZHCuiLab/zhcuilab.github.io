const i18n = {
  zh: {
    pageTitle: "研究方向 - 崔中华课题组",
    description: "崔中华课题组研究方向与研究兴趣",
    groupName: "崔中华课题组",
    ...
    interest2Title: "2. π共轭原子团簇体系",
    interest2Text: "π电子共轭模式为原子和分子间相互作用的多样化和丰富性提供了重要的保障，而探究新型原子间相互作用及稳定新奇原子团簇一直是分子科学研究的重要课题。该方向的突破不仅需要打破对原有原子间相互作用及稳定模式的束缚和原子团簇电子结构的设想，而且需要探究新型相互作用的稳定化机制，这是非常有挑战性的。我们利用π共轭体系发现了几类π共轭超配位原子团簇的稳定化机理，并以团簇型平面分子为建筑单元设计了具有奇特物理特性的平面超配位二维体系。",
    interest3Title: "3. 硼团簇体系",
    interest3Text: "硼原子缺电子特性使其倾向形成多中心键及离域π电子共轭模式，这是硼原子形成低维纳米材料的关键因素之一。利用多金属掺杂，对硼团簇几何、电子结构及稳定性展开系统理论研究，获得多个新型的硼团簇体系以及进一步加深对硼团簇的几何和电子结构、生长规律、稳定化机制的理解。",
    interest4Title: "4. 二维功能材料",
    interest4Text: "二维材料因其量子局域效应、尺寸效应、表面效应和量子隧穿效应等，展现出不同于体相材料的特性，因此成为凝聚态物理研究的焦点。课题组利用第一性原理计算，对二维材料的几何结构、电子结构及电子-声子耦合展开研究，通过深入分析层间成键、电荷转移与轨道杂化特征，阐明其电子结构特征与稳定性机制，重点探索其中可能存在的拓扑电子态及超导性质，获得了若干潜在的高温二维拓扑超导体，阐明了此类材料的结构-性能关系，为其物性调控及实验可控制备提供重要的理论依据。",
  ...
  en: {
    pageTitle: "Research - Cui Zhong-hua Research Group",
    description: "Research directions and interests of Cui Zhong-hua Research Group",
    ...
    interest2Title: "2. Pi-conjugated atomic cluster systems",
    interest2Text: "Pi-electron conjugation provides an essential foundation for the diversity and richness of atomic and molecular interactions, while exploring new types of interatomic interactions and stabilizing novel atomic clusters has long been a central topic in molecular science. Breakthroughs in this area require not only moving beyond conventional assumptions about interatomic interactions, stabilization modes, and the electronic structures of atomic clusters, but also uncovering the stabilization mechanisms of new types of interactions, which is highly challenging. Leveraging pi-conjugated frameworks, we have identified the stabilization mechanisms of several classes of pi-conjugated hypercoordinate atomic clusters and, using such cluster-like planar molecules as building blocks, designed planar hypercoordinate two-dimensional systems with unusual physical properties.",
    interest3Title: "3. Boron cluster systems",
    interest3Text: "The electron-deficient nature of boron favors the formation of multicenter bonds and delocalized pi-conjugated patterns, which is one of the key factors enabling boron to form low-dimensional nanomaterials. Using multi-metal doping, we carry out systematic theoretical studies on the geometric and electronic structures and stability of boron clusters, obtaining several novel boron cluster systems and further deepening the understanding of their geometric and electronic structures, growth patterns, and stabilization mechanisms.",
    interest4Title: "4. Two-dimensional functional materials",
    interest4Text: "Owing to quantum confinement, size effects, surface effects, and quantum tunneling, two-dimensional materials exhibit properties distinct from their bulk counterparts and have therefore become a central focus of condensed matter physics. The group uses first-principles calculations to investigate the geometric structures, electronic structures, and electron-phonon coupling of 2D materials, and through in-depth analyses of interlayer bonding, charge transfer, and orbital hybridization, elucidates their electronic structure characteristics and stabilization mechanisms, with particular emphasis on possible topological electronic states and superconductivity. We have identified several potential high-Tc 2D topological superconductors and clarified the structure-property relationships of such materials, providing important theoretical guidance for tuning their physical properties and for their controllable experimental preparation.",
