const i18n = {
  zh: {
    ...
    mapHintZh: "若地图未正常显示，可点击下方链接在新窗口打开高德地图。",
    mapHintEn: "当前页面为中文，地图使用高德地图。",
    mapOpenZh: "打开高德地图",
  ...
  en: {
    ...
    sectionMapTitle: "Map",
    mapHintZh: "Chinese map (Amap) is available on the Chinese page.",
    mapHintEn: "If the embedded map does not load, use the link below.",
    mapOpenZh: "Open Amap",
